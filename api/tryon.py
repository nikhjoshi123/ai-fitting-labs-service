...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        self._set_headers()
        # PRE-CHECK: Returns PAUSED or ACTIVE
    ...
    def do_POST(self):
        try:
            ...
            if "id" in ai_data:
                # 3. UPDATE SHEET1 ONLY (Keep it simple for now)
                ...
                self._set_headers(200)
                self.wfile.write(json.dumps({"error": "AI Rejected Request", "details": ai_data}).encode())
