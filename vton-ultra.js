(function() {
    ...
    async function sync() {
        ...
        } catch (e) { console.log("Mirror Sync..."); }
    }
        ...
        overlay.innerHTML = `
            <div style="background:#fff; border-radius:25px; overflow:hidden; max-width:400px; width:100%; box-shadow:0 25px 50px rgba(0,0,0,0.5);">
                ...
                <div style="padding:20px; text-align:center; font-family:sans-serif;">
                    ...
                    <div style="background:#f9f9f9; padding:10px; border-radius:12px; border:1px solid #eee;">
                    ...
                    <button id="v-close" style="margin-top:15px; width:100%; padding:12px; border-radius:12px; border:none; background:#000; color:#fff; font-weight:bold; cursor:pointer;">CLOSE MIRROR</button>
                </div>
            </div>
        `;
